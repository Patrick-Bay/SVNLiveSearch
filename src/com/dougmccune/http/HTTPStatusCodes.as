package com.dougmccune.http
{
	...
	public class HTTPStatusCodes
	{
		 ...
		 * completed. See section 8.2.3 for detailed discussion of the use and handling of 
		 * this status code. 
		 */
		public static const CONTINUE:String = "100";
		 ...
		 */
		public static const SWITCHING_PROTOCOLS:String = "101";
		 ...
		 */
		public static const OK:String = "200";
		 ...
		 * the response, with the most specific URI for the resource given by a Location 
		 ...
		 */ 
		public static const CREATED:String = "201";
		 ...
		 */
		public static const ACCEPTED:String = "202";
		 ...
		 * example, including local annotation information about the resource might result in a 
		 * superset of the metainformation known by the origin server. Use of this response code 
		 * is not required and is only appropriate when the response would otherwise be 200 (OK). 
		 */
		public static const NON_AUTHORITATIVE_INFORMATION:String = "203";
		
		/**
		 *  The server has fulfilled the request but does not need to return an entity-body, 
		 * and might want to return updated metainformation. The response MAY include new or updated 
		 * metainformation in the form of entity-headers, which if present SHOULD be associated with 
		 ...
		 */
		public static const NO_CONTENT:String = "204";
		 ...
		 */
		public static const RESET_CONTENT:String = "205";
		 ...
		 *      included with this response, or a multipart/byteranges Content-Type including 
		 *      Content-Range fields for each part. If a Content-Length header field is 
		 *      present in the response, its value MUST match the actual number of OCTETs 
		 ...
		 * include other entity-headers; this prevents inconsistencies between cached entity-bodies and 
		 * updated headers. Otherwise, the response MUST include all of the entity-headers that would 
		 ...
		 */
		public static const PARTIAL_CONTENT:String = "206";
		 ...
		 */
		public static const MULTIPLE_CHOICES:String = "300";
		 ...
		 * request.
		 */
		public static const MOVED_PERMANENTLY:String = "301";
	     ...
	     */
		public static const FOUND:String = "302";
	     ...
	     */
		public static const SEE_OTHER:String = "303";
		 ...
		 */
		public static const NOT_MODIFIED:String = "304";
		 ...
		 * by origin servers.
		 * 
		 * Note: RFC 2068 was not clear that 305 was intended to redirect a single request, 
		 * and to be generated by origin servers only.  Not observing these limitations has 
		 * significant security consequences.
		 */
		public static const USE_PROXY:String = "305";
		 ...
		 * request was issued. 
		 */
		public static const TEMPORARY_REDIRECT:String = "307";
		 ...
		 */
		public static const BAD_REQUEST:String = "400";
		
		/**
		 * The request requires user authentication. The response MUST include a 
		 * WWW-Authenticate header field (section 14.47) containing a challenge applicable to 
		 ...
		 */
		public static const UNAUTHORIZED:String = "401";
		 ...
		 * and the server wishes to make public why the request has not been fulfilled, it 
		 * SHOULD describe the reason for the refusal in the entity. If the server does not 
		 * wish to make this information available to the client, the status code 404 (Not Found) 
		 * can be used instead. 
		 */
		public static const FORBIDDEN:String = "403";
		 ...
		 * address. This status code is commonly used when the server does not wish to reveal 
		 * exactly why the request has been refused, or when no other response is applicable.
		 */ 
		public static const NOT_FOUND:String = "404";
		 ...
		 */
		public static const METHOD_NOT_ALLOWED:String = "405";
	     ...
	     */
		public static const NOT_ACCEPTABLE:String = "406";
		 ...
		 * Proxy-Authenticate header field (section 14.33) containing a challenge applicable 
		 * to the proxy for the requested resource. The client MAY repeat the request with a 
		 * suitable Proxy-Authorization header field (section 14.34). HTTP access 
		 * authentication is explained in "HTTP Authentication: Basic and Digest Access 
		 * Authentication" [43]. 
		 */
		public static const PROXY_AUTHENTICATION_REQUIRED:String = "407";
		 ...
		 */
		public static const REQUEST_TIMEOUT:String = "408";
		 ...
		 * which conflict with those made by an earlier (third-party) request, the server 
		 * might use the 409 response to indicate that it can't complete the request. In this 
		 ...
		 */
		public static const CONFLICT:String = "409";
		 ...
		 */
		public static const GONE:String = "410";
		
		/**
		 * The server refuses to accept the request without a defined Content- Length. The 
		 ...
		 */
		public static const LENGTH_REQUIRED:String = "411";
		 ...
		 * the one intended. 
		 */
		public static const PRECONDITION_FAILED:String = "412";
		 ...
		 * again. 
		 */
		public static const REQUEST_ENTITY_TOO_LARGE:String = "413";
		 ...
		 * the Request-URI. 
		 */
		public static const REQUEST_URI_TOO_LONG:String = "414";
		 ...
		 */
		public static const UNSUPPORTED_MEDIA_TYPE:String = "415";
		
		/**
		 *  A server SHOULD return a response with this status code if a request included a 
		 * Range request-header field (section 14.35), and none of the range-specifier values 
		 * in this field overlap the current extent of the selected resource, and the request 
		 * did not include an If-Range request-header field. (For byte-ranges, this means 
		 * that the first- byte-pos of all of the byte-range-spec values were greater than 
		 ...
		 */
		public static const REQUEST_RANGE_NOT_SATISFIABLE:String = "416";
		
		/**
		 * The expectation given in an Expect request-header field (see section 14.20) could 
		 ...
		 */
		public static const EXPECTATION_FAILED:String = "417";
		
		/**
		 * The server encountered an unexpected condition which prevented it from fulfilling 
		 * the request. 
		 */
		public static const INTERNAL_SERVER_ERROR:String = "500";
		 ...
		 */
		public static const NOT_IMPLEMENTED:String = "501";
		 ...
		 */
		public static const BAD_GATEWAY:String = "502";
		 ...
		 * 
		 * Note: The existence of the 503 status code does not imply that a server must use 
		 * it when becoming overloaded. Some servers may wish to simply refuse the connection.
		 */
		public static const SERVICE_UNAVAILABLE:String = "503";
		 ...
		 * request.
		 * 
		 * Note: Note to implementors: some deployed proxies are known to return 400 or 500 
		 * when DNS lookups time out.
		 */
		public static const GATEWAY_TIMEOUT:String = "504";
		 ...
		 */
		public static const HTTP_VERSION_NOT_SUPPORTED:String = "505";
